...
function Keep14() {
alert("Закончена загрузка документа");
}

function Keep15() {
alert("Попытка закрытия окна браузера и выгрузки документа");
}

var onerror = function Keep16() {
alert("Ошибка: ");
}

function Keep17() {
console.log("Перемещение окна");
}
...
function Keep19() {
console.log("Прокрутка окна или области");
}
